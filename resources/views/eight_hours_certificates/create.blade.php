        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Add 8-Hours Certificate</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('eight-hours-certificates.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="certificate_id" class="form-control" value="{{ old('certificate_id') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="missing_annual_training" class="form-label">Missing Annual Training</label>
                                    <input type="text" name="missing_annual_training" class="form-control" value="{{ old('missing_annual_training') }}">
